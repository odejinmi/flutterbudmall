...
//
//     final featuredproductsperser = featuredproductsperserFromJson(jsonString);

import 'dart:convert';

List<Featuredproductsperser> featuredproductsperserFromJson(String str) =>
    List<Featuredproductsperser>.from(
        json.decode(str).map((x) => Featuredproductsperser.fromJson(x)));

String featuredproductsperserToJson(List<Featuredproductsperser> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class Featuredproductsperser {
  Featuredproductsperser({
    this.id,
    this.sellerId,
    this.brandId,
    this.name,
  ...
  factory Featuredproductsperser.fromJson(Map<String, dynamic> json) =>
      Featuredproductsperser(
        id: json["id"],
